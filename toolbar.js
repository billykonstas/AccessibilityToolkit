...
function accessibilityTool ()
{
	...
	var greyscaleButton = document.getElementById('toolkit_contrast_greyscale');
	var brightButton = document.getElementById('toolkit_contrast_bright');
	var reverseButton = document.getElementById('toolkit_contrast_reverse');
