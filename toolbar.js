...
function accessibilityTool ()
{
	...
	var videoBlock = document.getElementById('toolkit_media_video_block');
	var soundBlock = document.getElementById('toolkit_media_sound_block');
...
{
	if (fontSize > 1) {
		//document.getElementById('mic-toolkit-fonts-up').classList.add('vi-font-enabled');
		...
		//document.getElementById('mic-toolkit-fonts-up').classList.remove('vi-font-enabled');
